...
def router(dataset_id, dataset_datasetName, dataset_description, dataset_address):
    if request.method == "GET":
        return get(dataset_id, dataset_datasetName, dataset_description, dataset_address)
    if request.method == "POST":
        return post()
    if request.method == "PUT":
        return put(dataset_id, dataset_datasetName, dataset_description, dataset_address)
    if request.method == "DELETE":
        return delete(dataset_id, dataset_datasetName, dataset_description, dataset_address)
